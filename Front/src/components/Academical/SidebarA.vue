<template>
    <vs-sidebar click-not-close :reduce="reduce" :reduce-not-hover-expand="notExpand" :hidden-background="hbackground" parent="body" default-index="1" color="primary" v-model="active">
        <vs-sidebar-group vs-icon="search" title="Buscar" class="sidebar-group">
            ...
            <Materia class="materia" v-for="resultado in resultados" v-bind:key="resultado.curso+resultado.title+resultado.seccion" v-bind:title="resultado.title" v-bind:datos="resultado"/>
        </vs-sidebar-group>
        <vs-sidebar-group vs-icon="search" title="Tus materias" class="sidebar-group">
            <MateriaAdd class="materia" v-for="resultado in elegidas" v-bind:key="resultado.curso+resultado.title+resultado.seccion" v-bind:title="resultado.title" v-bind:datos="resultado"/>
